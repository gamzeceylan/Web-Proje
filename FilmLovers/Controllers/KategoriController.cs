...
namespace FilmLovers.Controllers
{
    public class KategoriController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,KategorAd")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KategorAd")] Kategori kategori)
        {
            if (id != kategori.Id)
            {
                return NotFound();
