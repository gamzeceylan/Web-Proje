...
namespace FilmLovers.Controllers
{
    public class YazarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Soyad,KullaniciAdi,Sifre")] Yazar yazar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Soyad,KullaniciAdi,Sifre")] Yazar yazar)
        {
            if (id != yazar.Id)
            {
                return NotFound();
